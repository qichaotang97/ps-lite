...
inline void Start(int customer_id, int argc, char** argv) {
    Postoffice::Get()->Start(customer_id, argc, argv, true);
}
...
inline void StartAsync(int customer_id, int argc, char** argv) {
    Postoffice::Get()->Start(customer_id, argc, argv, false);
}
